import { AlertTriangle, Eye, CheckCircle, Play } from 'lucide-react'
  ...
  return (
    <div className="p-8">
      ...
      <div style={{display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '2rem'}}>
        <div className="card">
          <div className="p-6">
            <h3 className="text-xl font-semibold text-gray-900" style={{marginBottom: '1.5rem'}}>Live Feed - Camera 01</h3>
            <div style={{
              position: 'relative',
              ...
              <div style={{textAlign: 'center'}}>
                ...
                <p style={{fontSize: '1.125rem', color: '#9ca3af', fontWeight: '500'}}>Live Video Feed</p>
                <p style={{fontSize: '0.875rem', color: '#6b7280', marginTop: '0.5rem'}}>Resolution: 1920x1080 • 30fps</p>
              </div>
              
              {/* Overlay Chips */}
              <div style={{position: 'absolute', top: '1rem', left: '1rem', display: 'flex', gap: '0.5rem'}}>
                <EventTypeChip type="RED_SIGNAL" />
                <EventTypeChip type="PERSON_IN_TRACK" />
              </div>
